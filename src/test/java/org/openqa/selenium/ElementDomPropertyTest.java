...
class ElementDomPropertyTest extends JsoupDriverTestBase {
  ...
  void testShouldReturnAnAbsoluteUrlWhenGettingSrcAttributeOfAValidImgTag() {
    ...
    assertThat(img.getDomProperty("src")).isEqualTo(pages.whereIs("icon.gif"));
  }
  ...
  void testShouldReturnAnAbsoluteUrlWhenGettingHrefAttributeOfAValidAnchorTag() {
    ...
    assertThat(img.getDomProperty("href")).isEqualTo(pages.whereIs("icon.gif"));
  }
