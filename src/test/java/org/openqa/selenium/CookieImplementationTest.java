...
import com.asyncant.selenium.DomainHelper;
...
//@NeedsSecureServer
class CookieImplementationTest extends JsoupDriverTestBase {
...
//    assumeTrue(domainHelper.checkIsOnValidHostname());
    ...
    driver.get(domainHelper.getUrlForSecondValidHostname("/common/animals"));
...
//  @NotWorkingInRemoteBazelBuilds(FIREFOX)
  public void testShouldWalkThePathToDeleteACookie() {
    ...
    driver.get(domainHelper.getUrlForFirstValidHostname("/common/child/childPage.html"));
    Cookie cookie2 = new Cookie("rodent", "hamster", "/common/child");
    driver.manage().addCookie(cookie2);

    driver.get(domainHelper.getUrlForFirstValidHostname("/common/child/grandchild/grandchildPage.html"));
...
//  }
  ...
  public void deleteAllCookies() {
    ...
    Cookie cookie1 = new Cookie.Builder("fish1", "cod").domain(domainHelper.getHostName()).build();
    Cookie cookie2 =
        new Cookie.Builder("fish2", "tune").domain(domainHelper.getAlternateHostName()).build();
