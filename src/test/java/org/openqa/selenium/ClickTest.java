...
class ClickTest extends JsoupDriverTestBase {
  @BeforeEach
  public void setUp() {
...
//  }
  ...
  void testShouldBeAbleToClickOnAnElementInTheViewport() {
    String url = pages.clickOutOfBoundsPage;
...
//  @NotYetImplemented(SAFARI)
  public void testClicksASurroundingStrongTag() {
    driver.get(pages.clickTestTestClicksASurroundingStrongTagPage);
...
//    driver.get(pages.clickTestsGoogleMapPage);
...
//  @NotYetImplemented(SAFARI)
  public void testShouldBeAbleToClickOnAnElementGreaterThanTwoViewports() {
    String url = pages.clickTooBigPage;
    driver.get(url);
...
//  }
  ...
  void testShouldBeAbleToClickOnRTLLanguageLink() {
    String url = pages.whereIs("click_rtl.html");
    driver.get(url);
  ...
  void testShouldBeAbleToClickOnLinkInAbsolutelyPositionedFooter() {
    String url = pages.whereIs("fixedFooterNoScroll.html");
    driver.get(url);
  ...
  void testShouldBeAbleToClickOnLinkInAbsolutelyPositionedFooterInQuirksMode() {
    String url = pages.whereIs("fixedFooterNoScrollQuirksMode.html");
    driver.get(url);
...
//  }
  ...
  void testShouldBeAbleToClickOnALinkThatWrapsToTheNextLine() {
    driver.get(pages.whereIs("click_tests/link_that_wraps.html"));
...
//    driver.get(pages.whereIs("click_tests/span_that_wraps.html"));
//
...
//  }
  ...
  void clickingOnADisabledElementIsANoOp() {
    driver.get(pages.whereIs("click_tests/disabled_element.html"));
